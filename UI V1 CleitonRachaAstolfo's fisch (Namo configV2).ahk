...
PixelSearch, x, y, 224, 506, 597, 558, 0x434B5B,, Fast RGB
if (ErrorLevel = 0)
{
	
	if x < 358 ; LEFT = 1 ; 598 indicates where the script will see and say "ho, the pointer is on the left/right/middle" (this sound be on the BORDER of side you want, example: if you want the right side, take the locations of the pixels on the far LEFT of the RIGHT side, and same for the left side
	{
	pos := 1
	}
...
if pos = 3
	...
	PixelSearch, x, y, 75, 141, 729, 581, 0xFFFFFF,, Fast
		if (ErrorLevel = 0)
		{
                send \sss{enter}\
